...
var offset;
var r1=80, r2=60, r3, r5=60, r4=120, r6=150;
...
var BAC = deg(Math.atan((r2*Math.sin(rad(ABC)))/(r1+r2*Math.cos(rad(ABC)))));
var temp = 0;
//graphics section
var bc,pc;
var canvas;
...
$('#datatable1').css('font','"Comic Sans MS", cursive, sans-serif');
...
$( "#ABslider" ).on( "slide", function( c, ui ) { $('#ABspinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#ABspinner" ).on( "spin", function( c, ui ) { $('#ABslider').slider("value",ui.value); ptx=[]; pty=[]; } );
...
// monitoring change in value and connecting slider and number
// setting trace point coordinate arrays to empty on change of link length
$( "#crankslider" ).on( "slide", function( e, ui ) { $('#crankspinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#crankspinner" ).on( "spin", function( e, ui ) { $('#crankslider').slider("value",ui.value); ptx=[]; pty=[];} );
...
// monitoring change in value and connecting slider and number
// setting trace point coordinate arrays to empty on change of link length
$( "#omega2slider" ).on( "slide", function( c, ui ) { $('#omega2spinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#omega2spinner" ).on( "spin", function( c, ui ) { $('#omega2slider').slider("value",ui.value); ptx=[]; pty=[]; } );
...
e.ycoord=b.ycoord;
r3=Math.sqrt((r2*Math.cos(rad(360-ABC)))*(r2*Math.cos(rad(360-ABC)))+(r1+r2*Math.sin(rad(360-ABC)))*(r1+r2*Math.sin(rad(360-ABC))));
//alert();
omega4=(r2*omega2*Math.cos(rad(360-ABC))*Math.cos(rad(BAC+90))+r2*omega2*Math.sin(rad(360-ABC))*Math.sin(rad(BAC+90)))/r3;
//omega5 = 
...
omega5=((-r5*omega4*Math.cos(rad(90+BAC))/(r4*Math.cos(rad(360-DEO)))));
vde=-r5*omega4*Math.sin(rad(90+BAC))-r4*omega5*Math.sin(rad(360-DEO));
...
alpha4=(r2/r3)*(-omega2*omega2*Math.cos(rad(360-ABC-90+BAC))+alpha2*Math.sin(rad(360-ABC-90+BAC)))-(2*vbc*omega4/r3);
alpha5=(r5*(omega4*omega4*Math.sin(rad(90-BAC))-alpha4*Math.cos(rad(90-BAC)))+r4*omega5*omega5*Math.sin(rad(theta5)))/(r4*Math.cos(rad(theta5)));
aca=r2*alpha2;
aa.xcoord=250;
aa.ycoord=250;
...
ade=-r5*alpha4*Math.sin(rad(90-BAC))-r5*omega4*omega4*Math.cos(rad(90-BAC))-r4*alpha5*Math.sin(rad(theta5))-r4*omega5*omega5*Math.cos(rad(theta5));
thetaz=acttan((ad.xcoord-aa.xcoord),(ad.ycoord-aa.ycoord));
if(DEO>=0){
aed.xcoord=ad.xcoord+((pointdist(vd,ve)*pointdist(vd,ve))/r4)*Math.cos(rad(DEO));
aed.ycoord=ad.ycoord+((pointdist(vd,ve)*pointdist(vd,ve))/r4)*Math.sin(rad(DEO));}
else{
aed.xcoord=ad.xcoord-((pointdist(vd,ve)*pointdist(vd,ve))/r4)*Math.cos(rad(DEO));
aed.ycoord=ad.ycoord-((pointdist(vd,ve)*pointdist(vd,ve))/r4)*Math.sin(rad(DEO));}
...
<tr><td>A<sub>ca</sub></td><td>"+(pointdist(ac,aa)*0.5).toFixed(2)+"</td></tr>\
<tr><td>A<sub>cb</sub></td><td>"+(pointdist(ab,aa)*0.5).toFixed(2)+"</td></tr>\
<tr><td>A<sub>db</sub></td><td>"+(pointdist(ad,aa)*0.5).toFixed(2)+"</td></tr>\
<tr><td>A<sub>ea</sub></td><td>"+(pointdist(ae,aa)*0.5).toFixed(2)+"</td></tr>\
<tr><td>A<sub>xp</sub></td><td>"+(pointdist(ap,abc)*0.5).toFixed(2)+"</td></tr>\
</table>";
}
...
<table border='1'>\
<tr><th>Vector</th><th>Value (mm/s<sup>2</sup>)</th></tr>\
<tr><td>V<sub>ca</sub></td><td>"+((pointdist(vc,va))/1.5).toFixed(2)+"</td></tr>\
<tr><td>V<sub>cb</sub></td><td>"+((pointdist(vb,va))/1.5).toFixed(2)+"</td></tr>\
<tr><td>V<sub>db</sub></td><td>"+((pointdist(vd,va))/1.5).toFixed(2)+"</td></tr>\
<tr><td>V<sub>ea</sub></td><td>"+((pointdist(ve,va))/1.5).toFixed(2)+"</td></tr>\
<tr><td>V<sub>ed</sub></td><td>"+((pointdist(ve,vd))/1.5).toFixed(2)+"</td></tr>\
<tr><td>V<sub>ca'</sub></td><td>"+((pointdist(vc,vb))/1.5).toFixed(2)+"</td></tr>\
</table>";
}

function scalev1()
{
  if(vc.xcoord>550||vb.xcoord>550||vd.xcoord>550||ve.xcoord>550||vc.ycoord>350||vd.ycoord>350||vb.ycoord>350||ve.ycoord>350||vc.xcoord<0||vb.xcoord<0||vd.xcoord<0||ve.xcoord<0||vc.ycoord<0||vd.ycoord<0||vb.ycoord<0||ve.ycoord<0)
  {
...
function scalev2()
{
  if(vc.xcoord>600||vb.xcoord>600||vd.xcoord>600||ve.xcoord>600||vc.ycoord>450||vd.ycoord>450||vb.ycoord>450||ve.ycoord>450||vc.xcoord<0||vb.xcoord<0||vd.xcoord<0||ve.xcoord<0||vc.ycoord<0||vd.ycoord<0||vb.ycoord<0||ve.ycoord<0)
  {
...
function scalea1()
{
  if(ab.xcoord>550||ac.xcoord>550||ad.xcoord>550||ae.xcoord>550||ax.xcoord>550||ay.xcoord>550||ap.xcoord>550||aq.xcoord>550||abc.xcoord>550||aed.xcoord>550||ab.ycoord>350||ac.ycoord>350||ad.ycoord>350||ae.ycoord>350||ax.ycoord>350||ay.ycoord>350||ap.ycoord>350||aq.ycoord>350||abc.ycoord>350||aed.ycoord>350||ab.xcoord<0||ac.xcoord<0||ad.xcoord<0||ae.xcoord<0||ax.xcoord<0||ay.xcoord<0||ap.xcoord<0||aq.xcoord<0||abc.xcoord<0||aed.xcoord<0||ab.ycoord<0||ac.ycoord<0||ad.ycoord<0||ae.ycoord<0||ax.ycoord<0||ay.ycoord<0||ap.ycoord<0||aq.ycoord<0||abc.ycoord<0||aed.ycoord<0)
  {
...
function scalea2()
{
  if(ab.xcoord>600||ac.xcoord>600||ad.xcoord>600||ae.xcoord>600||ax.xcoord>600||ay.xcoord>600||ap.xcoord>600||aq.xcoord>600||abc.xcoord>600||aed.xcoord>600||ab.ycoord>450||ac.ycoord>450||ad.ycoord>450||ae.ycoord>450||ax.ycoord>450||ay.ycoord>450||ap.ycoord>450||aq.ycoord>450||abc.ycoord>450||aed.ycoord>450||ab.xcoord<0||ac.xcoord<0||ad.xcoord<0||ae.xcoord<0||ax.xcoord<0||ay.xcoord<0||ap.xcoord<0||aq.xcoord<0||abc.xcoord<0||aed.xcoord<0||ab.ycoord<0||ac.ycoord<0||ad.ycoord<0||ae.ycoord<0||ax.ycoord<0||ay.ycoord<0||ap.ycoord<0||aq.ycoord<0||abc.ycoord<0||aed.ycoord<0)
  {
...
function scalea3()
{
  if(ab.xcoord>650||ac.xcoord>650||ad.xcoord>650||ae.xcoord>650||ax.xcoord>650||ay.xcoord>650||ap.xcoord>650||aq.xcoord>650||abc.xcoord>650||aed.xcoord>650||ab.ycoord>500||ac.ycoord>500||ad.ycoord>500||ae.ycoord>500||ax.ycoord>500||ay.ycoord>500||ap.ycoord>500||aq.ycoord>500||abc.ycoord>500||aed.ycoord>500||ab.xcoord<0||ac.xcoord<0||ad.xcoord<0||ae.xcoord<0||ax.xcoord<0||ay.xcoord<0||ap.xcoord<0||aq.xcoord<0||abc.xcoord<0||aed.xcoord<0||ab.ycoord<0||ac.ycoord<0||ad.ycoord<0||ae.ycoord<0||ax.ycoord<0||ay.ycoord<0||ap.ycoord<0||aq.ycoord<0||abc.ycoord<0||aed.ycoord<0)
  {
...
function scalea4()
{
  if(ab.xcoord>500||ac.xcoord>500||ad.xcoord>500||ae.xcoord>500||ax.xcoord>500||ay.xcoord>500||ap.xcoord>500||aq.xcoord>500||abc.xcoord>500||aed.xcoord>500||ab.ycoord>400||ac.ycoord>400||ad.ycoord>400||ae.ycoord>400||ax.ycoord>400||ay.ycoord>400||ap.ycoord>400||aq.ycoord>400||abc.ycoord>400||aed.ycoord>400||ab.xcoord<0||ac.xcoord<0||ad.xcoord<0||ae.xcoord<0||ax.xcoord<0||ay.xcoord<0||ap.xcoord<0||aq.xcoord<0||abc.xcoord<0||aed.xcoord<0||ab.ycoord<0||ac.ycoord<0||ad.ycoord<0||ae.ycoord<0||ax.ycoord<0||ay.ycoord<0||ap.ycoord<0||aq.ycoord<0||abc.ycoord<0||aed.ycoord<0)
  {
...
function scalea5()
{
  if(ab.xcoord>750||ac.xcoord>750||ad.xcoord>750||ae.xcoord>750||ax.xcoord>750||ay.xcoord>750||ap.xcoord>750||aq.xcoord>750||abc.xcoord>750||aed.xcoord>750||ab.ycoord>600||ac.ycoord>600||ad.ycoord>600||ae.ycoord>600||ax.ycoord>600||ay.ycoord>600||ap.ycoord>600||aq.ycoord>600||abc.ycoord>600||aed.ycoord>600||ab.xcoord<0||ac.xcoord<0||ad.xcoord<0||ae.xcoord<0||ax.xcoord<0||ay.xcoord<0||ap.xcoord<0||aq.xcoord<0||abc.xcoord<0||aed.xcoord<0||ab.ycoord<0||ac.ycoord<0||ad.ycoord<0||ae.ycoord<0||ax.ycoord<0||ay.ycoord<0||ap.ycoord<0||aq.ycoord<0||abc.ycoord<0||aed.ycoord<0)
  {
...
function draw()
{
  ...
  // var titleElement = document.getElementById('titleincanvas');
  // titleElement.style.cssText = "font-family: 'Nunito', sans-serif; font-size: 16px; font-weight: bold;";
  // titleElement.innerHTML = "Forced Vibration System";
  // console.log("title")
...
function drawvel(ctx)
{
  ...
  document.getElementById('titleincanvas').innerHTML="Velocity Analysis";
  ...
  pointjoin(vc,vb,ctx,"black",2);
  pointjoin(vb,va,ctx,"black",2);
  pointjoin(vd,va,ctx,"green",2);
  pointjoin(ve,vd,ctx,"purple",2);
  ...
  drawArrow(vb.xcoord,vb.ycoord,ctx,90-BAC+(signof(omega4))*90,6,30,"#FF0000");
  drawArrow(ve.xcoord,ve.ycoord,ctx,90+(signof(ve.xcoord-va.xcoord))*90,6,30,"#FF0000");
  drawArrow(vd.xcoord,vd.ycoord,ctx,90-BAC-(signof(omega4))*90,6,30,"#FF0000");
  drawArrow(ve.xcoord,ve.ycoord,ctx,90-acttan((vd.ycoord-ve.ycoord),(vd.xcoord-ve.xcoord)),6,30,"#FF0000");

  document.getElementById("vc").style.position = 'absolute';
  document.getElementById("vb").style.position = 'absolute';
  document.getElementById("ve").style.position = 'absolute';
  document.getElementById("vd").style.position = 'absolute';
  document.getElementById("vde").style.position = 'absolute';
  document.getElementById("vbc").style.position = 'absolute';

  document.getElementById("vc").style.margin = '0';
  document.getElementById("vb").style.margin = '0';
  document.getElementById("ve").style.margin = '0';
  document.getElementById("vd").style.margin = '0';
  document.getElementById("vde").style.margin = '0';
  document.getElementById("vbc").style.margin = '0';

  document.getElementById("vc").style.width = '20px';
  document.getElementById("vb").style.width = '20px';
  document.getElementById("ve").style.height = '20px';
  document.getElementById("vd").style.width = '20px';
  document.getElementById("vde").style.width = '20px';
  document.getElementById("vbc").style.width = '20px';

  document.getElementById("vc").style.fontSize = '11px';
  document.getElementById("vb").style.fontSize = '11px';
  document.getElementById("ve").style.fontSize = '11px';
  document.getElementById("vd").style.fontSize = '11px';
  document.getElementById("vde").style.fontSize = '11px';
  document.getElementById("vbc").style.fontSize = '11px';

  document.getElementById("vc").style.left = ""+(-10+Math.round(60+va.xcoord+vc.xcoord)/2)+"px";
  document.getElementById("vc").style.top = ""+(-10+Math.round(200+va.ycoord+vc.ycoord)/2)+"px";
  document.getElementById("vb").style.left = ""+(-10+Math.round(60+va.xcoord+vb.xcoord)/2)+"px";
  document.getElementById("vb").style.top = ""+(-10+Math.round(200+va.ycoord+vb.ycoord)/2)+"px";
  document.getElementById("ve").style.left = ""+(-10+Math.round(60+ve.xcoord+va.xcoord)/2)+"px";
  document.getElementById("ve").style.top = ""+(-10+Math.round(760)/2)+"px";
  document.getElementById("vd").style.left = ""+(-10+Math.round(60+va.xcoord+vd.xcoord)/2)+"px";
  document.getElementById("vd").style.top = ""+(-10+Math.round(200+va.ycoord+vd.ycoord)/2)+"px";
  document.getElementById("vde").style.left = ""+(-10+Math.round(60+ve.xcoord+vd.xcoord)/2)+"px";
  document.getElementById("vde").style.top = ""+(-10+Math.round(200+ve.ycoord+vd.ycoord)/2)+"px";
  document.getElementById("vbc").style.left = ""+(-10+Math.round(60+vb.xcoord+vc.xcoord)/2)+"px";
  document.getElementById("vbc").style.top = ""+(-10+Math.round(200+vb.ycoord+vc.ycoord)/2)+"px";
...
function drawacc(ctx)
{
  ...
  document.getElementById('titleincanvas').innerHTML="Acceleration Analysis";
  document.getElementById('scale').innerHTML="Scale: "+scale+":1";
  scale=1;
  $('#datatable2').hide();
  ...
  drawArrow(ac.xcoord,ac.ycoord,ctx,90+ABC-rotstatus*90,6,30,"#FF0000");
  drawArrow(ae.xcoord,ae.ycoord,ctx,90+(signof(ae.xcoord-aa.xcoord))*90,6,30,"#FF0000");
  drawArrow(ab.xcoord,ab.ycoord,ctx,90-BAC-180,6,30,"#FF0000");
  drawArrow(ap.xcoord,ap.ycoord,ctx,90-BAC+(signof(omega4))*90,6,30,"#FF0000");
  drawArrow(abc.xcoord,abc.ycoord,ctx,90-BAC+(signof(omega4))*90,6,30,"#FF0000");
  drawArrow(abc.xcoord,abc.ycoord,ctx,90+thetax,6,30,"#FF0000");
  drawArrow(ad.xcoord,ad.ycoord,ctx,thetay,6,30,"#FF0000");
  drawArrow(aed.xcoord,aed.ycoord,ctx,DEO+90+(signof(aed.xcoord-ad.xcoord))*90,6,30,"#FF0000");
  drawArrow(ae.xcoord,ae.ycoord,ctx,acttan((ad.xcoord-ae.xcoord),(ad.ycoord-ae.ycoord)),6,30,"#FF0000");
  drawArrow(ae.xcoord,ae.ycoord,ctx,acttan((aed.xcoord-ae.xcoord),(aed.ycoord-ae.ycoord)),6,30,"#FF0000");
  ...
  document.getElementById("ae").style.position = 'absolute';
  document.getElementById("aca").style.position = 'absolute';
  document.getElementById("acb").style.position = 'absolute';
  document.getElementById("ap").style.position = 'absolute';
  document.getElementById("abc").style.position = 'absolute';
  document.getElementById("aed").style.position = 'absolute';
  document.getElementById("ax").style.position = 'absolute';
  document.getElementById("ay").style.position = 'absolute';

  document.getElementById("ac").style.margin = '0';
  document.getElementById("ad").style.margin = '0';
  document.getElementById("ab").style.margin = '0';
  document.getElementById("ae").style.margin = '0';
  document.getElementById("aca").style.margin = '0';
  document.getElementById("acb").style.margin = '0';
  document.getElementById("ap").style.margin = '0';
  document.getElementById("abc").style.margin = '0';
  document.getElementById("aed").style.margin = '0';
  document.getElementById("ax").style.margin = '0';
  document.getElementById("ay").style.margin = '0';
  ...
  document.getElementById("ae").style.width = '20px';
  document.getElementById("aca").style.width = '20px';
  document.getElementById("acb").style.width = '20px';
  document.getElementById("ap").style.width = '20px';
  document.getElementById("abc").style.width = '20px';
  document.getElementById("aed").style.height = '20px';
  document.getElementById("ax").style.width = '20px';
  document.getElementById("ay").style.width = '20px';

  document.getElementById("ac").style.fontSize = '11px';
  document.getElementById("ad").style.fontSize = '11px';
  document.getElementById("ab").style.fontSize = '11px';
  document.getElementById("ae").style.fontSize = '11px';
  document.getElementById("aca").style.fontSize = '11px';
  document.getElementById("acb").style.fontSize = '11px';
  document.getElementById("ap").style.fontSize = '11px';
  document.getElementById("abc").style.fontSize = '11px';
  document.getElementById("aed").style.fontSize = '11px';
  document.getElementById("ax").style.fontSize = '11px';
  document.getElementById("ay").style.fontSize = '11px';

  document.getElementById("ac").style.left = ""+(-10+Math.round(60+aa.xcoord+ac.xcoord)/2)+"px";
  document.getElementById("ac").style.top = ""+(-10+Math.round(200+aa.ycoord+ac.ycoord)/2)+"px";
  document.getElementById("ad").style.left = ""+(-10+Math.round(60+aa.xcoord+ad.xcoord)/2)+"px";
  document.getElementById("ad").style.top = ""+(-10+Math.round(200+aa.ycoord+ad.ycoord)/2)+"px";
  document.getElementById("ab").style.left = ""+(-10+Math.round(60+aa.xcoord+ab.xcoord)/2)+"px";
  document.getElementById("ab").style.top = ""+(-10+Math.round(200+aa.ycoord+ab.ycoord)/2)+"px";
  document.getElementById("ae").style.left = ""+(-10+Math.round(60+aa.xcoord+ae.xcoord)/2)+"px";
  document.getElementById("ae").style.top = ""+(-10+Math.round(710)/2)+"px";
  document.getElementById("aca").style.left = ""+(-10+Math.round(60+abc.xcoord+ap.xcoord)/2)+"px";
  document.getElementById("aca").style.top = ""+(-10+Math.round(200+abc.ycoord+ap.ycoord)/2)+"px";
  document.getElementById("acb").style.left = ""+(-10+Math.round(60+ab.xcoord+abc.xcoord)/2)+"px";
  document.getElementById("acb").style.top = ""+(-10+Math.round(200+ab.ycoord+abc.ycoord)/2)+"px";
  document.getElementById("ap").style.left = ""+(-10+Math.round(60+ac.xcoord+ap.xcoord)/2)+"px";
  document.getElementById("ap").style.top = ""+(-10+Math.round(200+ac.ycoord+ap.ycoord)/2)+"px";
  document.getElementById("abc").style.left = ""+(-10+Math.round(60+abc.xcoord+ac.xcoord)/2)+"px";
  document.getElementById("abc").style.top = ""+(-10+Math.round(200+abc.ycoord+ac.ycoord)/2)+"px";
  document.getElementById("aed").style.left = ""+(-10+Math.round(60+ae.xcoord+ad.xcoord)/2)+"px";
  document.getElementById("aed").style.top = ""+(-10+Math.round(200+ae.ycoord+ad.ycoord)/2)+"px";
  document.getElementById("ax").style.left = ""+(-10+Math.round(60+aed.xcoord+ad.xcoord)/2)+"px";
  document.getElementById("ax").style.top = ""+(-10+Math.round(200+aed.ycoord+ad.ycoord)/2)+"px";
  document.getElementById("ay").style.left = ""+(-10+Math.round(60+aed.xcoord+ae.xcoord)/2)+"px";
  document.getElementById("ay").style.top = ""+(-10+Math.round(200+aed.ycoord+ae.ycoord)/2)+"px";
